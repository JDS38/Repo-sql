...
drop user C##rparis cascade;

create user C##rparis identified by rparis
default tablespace users;

grant connect, resource to C##rparis;
GRANT UNLIMITED TABLESPACE TO C##rparis;

connect C##rparis/rparis
