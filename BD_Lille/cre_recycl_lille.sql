...
drop user C##rlille cascade;

create user C##rlille identified by rlille
default tablespace users;

grant connect, resource to C##rlille;
GRANT UNLIMITED TABLESPACE TO C##rlille;

connect C##rlille/rlille
